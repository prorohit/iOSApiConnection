...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of iOSApiConnection.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/shiva_sravan.naidu@students.tamuk.edu/iOSApiConnection'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'shiva_sravan.naidu@students.tamuk.edu' => 'shiva_sravan.naidu@students.tamuk.edu' }
  s.source           = { :git => 'https://github.com/shiva_sravan.naidu@students.tamuk.edu/iOSApiConnection.git', :tag => s.version.to_s }

...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
This helper class will make it very easy to call the json based APIs. This helper can also be used for uploading the images and videos to server with progress.In this version, code for uploading the files to the server has been added.
                       DESC
